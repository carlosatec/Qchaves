...
./modo-address -f Puzzles/21.txt -b 21 -l compress -R random -t 8

# Busca backward (do fim para o início)
./modo-address -f Puzzles/21.txt -b 21 -l compress -R backward -t 8

# Busca both (metade das threads cada lado)
./modo-address -f Puzzles/21.txt -b 21 -l compress -R both -t 8
...
./modo-bsgs -f Puzzles/66.txt -b 66 -t 8

# BSGS modo random (para puzzles)
./modo-bsgs -R random -f Puzzles/66.txt -b 66 -t 8

# Com mais RAM (k=32)
./modo-bsgs -f Puzzles/66.txt -b 66 -k 32 -t 16

# Auto-tuning
./modo-bsgs -A balanced -f Puzzles/66.txt -b 66
```
...
```bash
# Kangaroo normal
./modo-kangaroo -p 02ABCD... -b 130 -r 0:FFFFFFFFFFFFFFFF -t 12 -d 22 -j 48 -w 40

# Auto-tuning (recomendado)
./modo-kangaroo -A balanced -p 02ABCD... -b 130 -r 0:FFFFFFFFFFFFFFFF
```
